...
def SSD(input_shape, num_classes):
    ...
    # Block 9
    net['conv9_1'] = Conv2D(128, (1, 1), activation='relu',padding='same',name='conv9_1')(net['conv8_2'])
    net['conv9_2'] = Conv2D(256, (3, 3), strides=(2, 2),activation='relu', padding='same',name='conv9_2')(net['conv9_1'])
    # Block 10
    net['conv10_1'] = Conv2D(128, (1, 1), activation='relu',padding='same',name='conv10_1')(net['conv9_2'])
    net['conv10_2'] = Conv2D(256, (3, 3), strides=(2, 2),activation='relu', padding='same',name='conv10_2')(net['conv10_1'])
    ...
    priorbox = PriorBox(img_size, 35.84, max_size=76.8, aspect_ratios=[2],variances=[0.1, 0.1, 0.2, 0.2],name='conv4_3_norm_mbox_priorbox')
    ...
    priorbox = PriorBox(img_size, 76.8, max_size=153.6, aspect_ratios=[2, 3],variances=[0.1, 0.1, 0.2, 0.2],name='fc7_mbox_priorbox')
    ...
    priorbox = PriorBox(img_size, 153.6, max_size=230.4, aspect_ratios=[2, 3],variances=[0.1, 0.1, 0.2, 0.2],name='conv6_2_mbox_priorbox')
    ...
    priorbox = PriorBox(img_size, 230.4, max_size=307.2, aspect_ratios=[2, 3],variances=[0.1, 0.1, 0.2, 0.2],name='conv7_2_mbox_priorbox')
    ...
    priorbox = PriorBox(img_size, 307.2, max_size=384.0, aspect_ratios=[2, 3],variances=[0.1, 0.1, 0.2, 0.2],name='conv8_2_mbox_priorbox')
    net['conv8_2_mbox_priorbox'] = priorbox(net['conv8_2'])
    # Prediction from conv9_2
    num_priors = 4
    x = Conv2D(num_priors * 4, (3,3), padding='same',name='conv9_2_mbox_loc')(net['conv9_2'])
    ...
    if num_classes != 21:
        name += '_{}'.format(num_classes)
    x = Conv2D(num_priors * num_classes, (3,3), padding='same',name=name)(net['conv9_2'])
    ...
    priorbox = PriorBox(img_size, 384.0, max_size=460.8, aspect_ratios=[2],variances=[0.1, 0.1, 0.2, 0.2],name='conv9_2_mbox_priorbox')
    ...
    priorbox = PriorBox(img_size, 460.8, max_size=537.6, aspect_ratios=[2],variances=[0.1, 0.1, 0.2, 0.2],name='pool6_mbox_priorbox')
    ...
    net['mbox_loc'] = concatenate([net['conv4_3_norm_mbox_loc_flat'],net['fc7_mbox_loc_flat'],net['conv6_2_mbox_loc_flat'],net['conv7_2_mbox_loc_flat'],net['conv8_2_mbox_loc_flat'],net['conv9_2_mbox_loc_flat'],net['pool6_mbox_loc_flat']],axis=1, name='mbox_loc')
    net['mbox_conf'] = concatenate([net['conv4_3_norm_mbox_conf_flat'],net['fc7_mbox_conf_flat'],net['conv6_2_mbox_conf_flat'],net['conv7_2_mbox_conf_flat'],net['conv8_2_mbox_conf_flat'],net['conv9_2_mbox_conf_flat'],net['pool6_mbox_conf_flat']],axis=1, name='mbox_conf')
    net['mbox_priorbox'] = concatenate([net['conv4_3_norm_mbox_priorbox'],net['fc7_mbox_priorbox'],net['conv6_2_mbox_priorbox'],net['conv7_2_mbox_priorbox'],net['conv8_2_mbox_priorbox'],net['conv9_2_mbox_priorbox'],net['pool6_mbox_priorbox']],axis=1,name='mbox_priorbox')
